{
  ...
  if (!accessToken) {
    ...
    location.href = `https://discord.com/oauth2/authorize?client_id=924829035308146810&redirect_uri=https://jumblejot.spdblx.repl.co/app/&response_type=token&scope=identify%20email%20guilds&state=${btoa(randomString)}`
  }
